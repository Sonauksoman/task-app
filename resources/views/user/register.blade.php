              ...
              @endif
                ...
                @csrf
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      <input type="password" id="form3Example4cd" class="form-control @error('confirm_password') is-invalid @enderror" name="confirm_password"/>
                      @error('confirm_password') <p class="alert alert-danger">{{$message}}</p>  @enderror
                      <label class="form-label" for="form3Example4cd">Repeat your password</label>
                    </div>
                  </div>
                  <button type="button" class="btn btn-success" > <a style="text-decoration:none;color:white;" href="/">Login</a></button>
